"""Resource classes for the Screen schemes API group."""
...
class ScreenSchemes(SyncAPIResource):
    """Synchronous resource for the Screen schemes API group."""
    ...
    def create_screen_scheme(self, body: ScreenSchemeDetails) -> ScreenSchemeId:
...
class AsyncScreenSchemes(AsyncAPIResource):
    """Asynchronous resource for the Screen schemes API group."""
    ...
    async def create_screen_scheme(self, body: ScreenSchemeDetails) -> ScreenSchemeId:
        """Create screen scheme"""
