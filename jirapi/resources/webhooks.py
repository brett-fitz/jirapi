"""Resource classes for the Webhooks API group."""
...
class Webhooks(SyncAPIResource):
    """Synchronous resource for the Webhooks API group."""
    ...
    def refresh_webhooks(self, body: ContainerForWebhookIDs) -> WebhooksExpirationDate:
        """Extend webhook life"""
        resp = self._client._request(
            "PUT",
...
class AsyncWebhooks(AsyncAPIResource):
    """Asynchronous resource for the Webhooks API group."""
    ...
    async def refresh_webhooks(self, body: ContainerForWebhookIDs) -> WebhooksExpirationDate:
        """Extend webhook life"""
        resp = await self._client._request(
            "PUT",
            "/rest/api/3/webhook/refresh",
