"""Resource classes for the Avatars API group."""
...
class Avatars(SyncAPIResource):
    """Synchronous resource for the Avatars API group."""

    def get_all_system_avatars(self, type_: str) -> SystemAvatars:
        """Get system avatars by type"""
        resp = self._client._request("GET", f"/rest/api/3/avatar/{type_}/system")
        return SystemAvatars.model_validate(resp.json())

    def get_avatars(self, type_: str, entity_id: str) -> AvatarsModel:
        """Get avatars"""
...
class AsyncAvatars(AsyncAPIResource):
    """Asynchronous resource for the Avatars API group."""

    async def get_all_system_avatars(self, type_: str) -> SystemAvatars:
        """Get system avatars by type"""
        resp = await self._client._request("GET", f"/rest/api/3/avatar/{type_}/system")
        return SystemAvatars.model_validate(resp.json())

    async def get_avatars(self, type_: str, entity_id: str) -> AvatarsModel:
        """Get avatars"""
