"""Resource classes for the Workflows API group."""
...
class Workflows(SyncAPIResource):
    """Synchronous resource for the Workflows API group."""

    def read_workflow_from_history(
    ...
    def read_workflows(self, body: WorkflowReadRequest) -> WorkflowReadResponse:
        """Bulk get workflows"""
        resp = self._client._request(
    ...
    def create_workflows(self, body: WorkflowCreateRequest) -> WorkflowCreateResponse:
    ...
    def read_workflow_previews(self, body: WorkflowPreviewRequest) -> WorkflowPreviewResponse:
        """Preview workflow"""
        resp = self._client._request(
            "POST",
    ...
    def update_workflows(self, body: WorkflowUpdateRequest) -> WorkflowUpdateResponse:
    ...
    def validate_update_workflows(
        self, body: WorkflowUpdateValidateRequestBean
    ) -> WorkflowValidationErrorList:
...
class AsyncWorkflows(AsyncAPIResource):
    """Asynchronous resource for the Workflows API group."""

    async def read_workflow_from_history(
        self, body: WorkflowHistoryReadRequest
    ) -> WorkflowHistoryReadResponseDTO:
        """Read workflow version from history"""
    ...
    async def read_workflows(self, body: WorkflowReadRequest) -> WorkflowReadResponse:
        """Bulk get workflows"""
        resp = await self._client._request(
            "POST", "/rest/api/3/workflows", json=body.model_dump(by_alias=True, exclude_none=True)
        )
    ...
    async def create_workflows(self, body: WorkflowCreateRequest) -> WorkflowCreateResponse:
        """Bulk create workflows"""
        resp = await self._client._request(
            "POST",
            "/rest/api/3/workflows/create",
    ...
    async def read_workflow_previews(self, body: WorkflowPreviewRequest) -> WorkflowPreviewResponse:
        """Preview workflow"""
        resp = await self._client._request(
            "POST",
            "/rest/api/3/workflows/preview",
    ...
    async def update_workflows(self, body: WorkflowUpdateRequest) -> WorkflowUpdateResponse:
        """Bulk update workflows"""
        resp = await self._client._request(
            "POST",
            "/rest/api/3/workflows/update",
