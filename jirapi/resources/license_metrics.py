"""Resource classes for the License metrics API group."""
...
class LicenseMetrics(SyncAPIResource):
    """Synchronous resource for the License metrics API group."""
    ...
    def get_approximate_license_count(self) -> LicenseMetric:
    ...
    def get_approximate_application_license_count(self, application_key: str) -> LicenseMetric:
...
class AsyncLicenseMetrics(AsyncAPIResource):
    """Asynchronous resource for the License metrics API group."""
    ...
    async def get_approximate_license_count(self) -> LicenseMetric:
        """Get approximate license count"""
