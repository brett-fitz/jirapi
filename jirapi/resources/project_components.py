"""Resource classes for the Project components API group."""
...
class ProjectComponents(SyncAPIResource):
    """Synchronous resource for the Project components API group."""
    ...
    def find_components_for_projects(
        ...
        *,
        ...
        return PageBean2ComponentJsonBean.model_validate(resp.json())

    def create_component(self, body: ProjectComponent) -> ProjectComponent:
        """Create component"""
    ...
    def update_component(self, id_: str, body: ProjectComponent) -> ProjectComponent:
        """Update component"""
        resp = self._client._request(
            "PUT",
    ...
    def get_component_related_issues(self, id_: str) -> ComponentIssuesCount:
...
class AsyncProjectComponents(AsyncAPIResource):
    """Asynchronous resource for the Project components API group."""
    ...
    async def create_component(self, body: ProjectComponent) -> ProjectComponent:
        """Create component"""
    ...
    async def update_component(self, id_: str, body: ProjectComponent) -> ProjectComponent:
        """Update component"""
        resp = await self._client._request(
            "PUT",
            f"/rest/api/3/component/{id_}",
    ...
    async def get_component_related_issues(self, id_: str) -> ComponentIssuesCount:
        """Get component issues count"""
