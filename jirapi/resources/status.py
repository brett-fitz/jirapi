"""Resource classes for the Status API group."""
...
class Status(SyncAPIResource):
    """Synchronous resource for the Status API group."""
    ...
    def create_statuses(self, body: StatusCreateRequest) -> JiraStatus:
    ...
    def get_statuses_by_name(self, *, name: list[str], project_id: str | None = None) -> JiraStatus:
...
class AsyncStatus(AsyncAPIResource):
    """Asynchronous resource for the Status API group."""
    ...
    async def create_statuses(self, body: StatusCreateRequest) -> JiraStatus:
        """Bulk create statuses"""
    ...
    async def get_statuses_by_name(
        self, *, name: list[str], project_id: str | None = None
    ) -> JiraStatus:
        """Bulk get statuses by name"""
        params = self._client._build_params(**{"name": name, "projectId": project_id})
