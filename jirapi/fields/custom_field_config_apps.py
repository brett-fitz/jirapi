"""Resource classes for fields.custom_field_config_apps."""
...
class FieldCustomFieldConfigApps(SyncAPIResource):
    """Synchronous resource for fields.custom_field_config_apps."""
    ...
    def update_configuration(self, field_id_or_key: str, body: CustomFieldConfigurations) -> None:
...
class AsyncFieldCustomFieldConfigApps(AsyncAPIResource):
    """Asynchronous resource for fields.custom_field_config_apps."""
