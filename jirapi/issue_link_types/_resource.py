"""Resource classes for issue_link_types."""
...
class IssueLinkTypes(SyncAPIResource):
    """Synchronous resource for issue_link_types."""
    ...
    def create(self, body: IssueLinkType) -> IssueLinkType:
    ...
    def delete(self, issue_link_type_id: str) -> None:
    ...
    def update(self, issue_link_type_id: str, body: IssueLinkType) -> IssueLinkType:
...
class AsyncIssueLinkTypes(AsyncAPIResource):
    """Asynchronous resource for issue_link_types."""
    ...
    async def create(self, body: IssueLinkType) -> IssueLinkType:
        """Create issue link type"""
    ...
    async def delete(self, issue_link_type_id: str) -> None:
        """Delete issue link type"""
    ...
    async def update(self, issue_link_type_id: str, body: IssueLinkType) -> IssueLinkType:
        """Update issue link type"""
        resp = await self._client._request(
            "PUT",
            f"/rest/api/3/issueLinkType/{issue_link_type_id}",
