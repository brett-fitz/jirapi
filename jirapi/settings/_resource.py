"""Resource classes for settings."""

from __future__ import annotations

from jirapi._resource import AsyncAPIResource, SyncAPIResource
from jirapi.models import ApplicationProperty, Configuration, SimpleApplicationProperty


class Settings(SyncAPIResource):
    """Synchronous resource for settings."""
...
class AsyncSettings(AsyncAPIResource):
    """Asynchronous resource for settings."""
    ...
    async def get_advanced(self) -> ApplicationProperty:
        """Get advanced settings"""
        resp = await self._client._request(
