"""Resource classes for issues.watchers."""
...
class IssueWatchers(SyncAPIResource):
    """Synchronous resource for issues.watchers."""

    def is_watching_bulk(self, body: IssueList) -> BulkIssueIsWatching:
    ...
    def list(self, issue_id_or_key: str) -> Watchers:
        """Get issue watchers"""
...
class AsyncIssueWatchers(AsyncAPIResource):
    """Asynchronous resource for issues.watchers."""

    async def is_watching_bulk(self, body: IssueList) -> BulkIssueIsWatching:
        """Get is watching issue bulk"""
    ...
    async def list(self, issue_id_or_key: str) -> Watchers:
        """Get issue watchers"""
