"""Resource classes for issues.remote_links."""
...
class IssueRemoteLinks(SyncAPIResource):
    """Synchronous resource for issues.remote_links."""

    def delete_by_global_id(self, issue_id_or_key: str, *, global_id: str) -> None:
    ...
    def list(self, issue_id_or_key: str, *, global_id: str | None = None) -> RemoteIssueLink:
    ...
    def delete_by_id(self, issue_id_or_key: str, link_id: str) -> None:
        """Delete remote issue link by ID"""
        self._client._request("DELETE", f"/rest/api/3/issue/{issue_id_or_key}/remotelink/{link_id}")
        return None

    def get_by_id(self, issue_id_or_key: str, link_id: str) -> RemoteIssueLink:
    ...
    def update(self, issue_id_or_key: str, link_id: str, body: RemoteIssueLinkRequest) -> None:
...
class AsyncIssueRemoteLinks(AsyncAPIResource):
    """Asynchronous resource for issues.remote_links."""

    async def delete_by_global_id(self, issue_id_or_key: str, *, global_id: str) -> None:
        """Delete remote issue link by global ID"""
        params = self._client._build_params(**{"globalId": global_id})
    ...
    async def list(self, issue_id_or_key: str, *, global_id: str | None = None) -> RemoteIssueLink:
        """Get remote issue links"""
        params = self._client._build_params(**{"globalId": global_id})
    ...
    async def delete_by_id(self, issue_id_or_key: str, link_id: str) -> None:
        """Delete remote issue link by ID"""
        await self._client._request(
    ...
    async def get_by_id(self, issue_id_or_key: str, link_id: str) -> RemoteIssueLink:
        """Get remote issue link by ID"""
        resp = await self._client._request(
            "GET", f"/rest/api/3/issue/{issue_id_or_key}/remotelink/{link_id}"
        )
