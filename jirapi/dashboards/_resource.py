"""Resource classes for dashboards."""
...
class Dashboards(SyncAPIResource):
    """Synchronous resource for dashboards."""
    ...
    def bulk_edit(self, body: BulkEditShareableEntityRequest) -> BulkEditShareableEntityResponse:
    ...
    def list_available_gadgets(self) -> AvailableDashboardGadgetsResponse:
    ...
    def get_item_property_keys(self, dashboard_id: str, item_id: str) -> PropertyKeys:
    ...
    def delete_item_property(self, dashboard_id: str, item_id: str, property_key: str) -> None:
    ...
    def set_item_property(self, dashboard_id: str, item_id: str, property_key: str) -> None:
...
class AsyncDashboards(AsyncAPIResource):
    """Asynchronous resource for dashboards."""
    ...
    async def list_available_gadgets(self) -> AvailableDashboardGadgetsResponse:
        """Get available gadgets"""
    ...
    async def get_item_property_keys(self, dashboard_id: str, item_id: str) -> PropertyKeys:
        """Get dashboard item property keys"""
        resp = await self._client._request(
            "GET", f"/rest/api/3/dashboard/{dashboard_id}/items/{item_id}/properties"
        )
    ...
    async def set_item_property(self, dashboard_id: str, item_id: str, property_key: str) -> None:
        """Set dashboard item property"""
        await self._client._request(
            "PUT", f"/rest/api/3/dashboard/{dashboard_id}/items/{item_id}/properties/{property_key}"
        )
    ...
    async def get(self, id_: str) -> Dashboard:
        """Get dashboard"""
